...
radiologistSchema.methods.generateAuthToken = async function(){
    try{
...
const radiologist_model = mongoose.model("radiologist",radiologistSchema,"radiologists");
console.log('Radiologist schema Model build');
module.exports = radiologist_model;