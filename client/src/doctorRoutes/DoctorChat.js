...
const DoctorChat = () => {
  ...
  const sendMessage = (e) => {
    ...
    setMessages([
      ...messages,
      { text: newMessage, senderId: currentUser },
    ]);
    sendMessageToDb();
    const message = {
        ...
        <div class="col-xs-12 ">
          {/* <!-- Panel Chat --> */}
            <div class="panel-heading mt-2">
              ...
              {/* <button onClick={()=>navigate('/doctorRoutes/videoCall')}>Video</button> */}
            </div>
