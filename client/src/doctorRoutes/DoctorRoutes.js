...
import DoctorSidebar from '../components/NewDoctorSidebar'
const DoctorRoutes = () => {
  const [open, setOpen] = useState(false);
  const [userInfo, setUserInfo] = useState({});
  useEffect(() => {
    fetch("http://localhost:4000/doctor/getInfo", {
      method: "GET",
      headers: {
        ...
        <nav class="navbar navbar-expand navbar-dark sticky-top px-4 py-0" style={{backgroundColor:"#52799b"}}>
          ...
          <div class="navbar-nav align-items-center ms-auto ">
            ...
            <div class="ms-2">
              ...
              <label className="ms-2 text-white fst-italic">Doctor</label>
