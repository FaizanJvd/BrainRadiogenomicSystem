...
const RecepProfile = () => {
  ...
  const getData = async (e) => {
    const res = await fetch("http://localhost:4000/receptionist/getProfile", {
      method: "GET",
      headers: {
  ...
  const editSave = async (e) => {
    ...
    const res = await fetch(
      "http://localhost:4000/receptionist/updateProfile",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  const sendImage = async () => {
    if (file !== null && picture !== null) {
      if (checkExtension) {
        const res = await fetch(
          "http://localhost:4000/receptionist/uploadImage",
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
