...
const ViewReceptionist = () => {
  ...
  const postData = async (e) => {
    ...
    const res = await fetch("http://localhost:4000/updateReceptionist", {
      method: "POST",
      headers: {
  ...
  async function getData() {
    const res = await fetch("http://localhost:4000/getReceptionist", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  async function deleteclickedFunction(d_id) {
    const res = await fetch("http://localhost:4000/deleteReceptionist", {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const filterData = async (value) => {
    const res = await fetch("http://localhost:4000/filter/filterReceptionist", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
