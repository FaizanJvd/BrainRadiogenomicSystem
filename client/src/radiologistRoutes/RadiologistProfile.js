...
const RadiologistProfile = () => {
  ...
  const getData = async (e) => {
    const res = await fetch("http://localhost:4000/radiologist/getProfile", {
      method: "GET",
      headers: {
  ...
  const editSave = async (e) => {
    ...
    const res = await fetch(
      "http://localhost:4000/radiologist/updateProfile",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  const sendImage = async () => {
    if (file !== null && picture !== null) {
      if (checkExtension) {
        const res = await fetch("http://localhost:4000/radiologist/uploadImage", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
            ...
            >
              <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                ...
                <button
                  ...
                  title="Upload Image"
                  style={{borderRadius:"20px",backgroundColor:"rgb(2, 5, 183)",color:"white"}}
